...
DictInfoDlg.deleteItem = function (event) {
    var obj = EASYLIAO.eventParseObject(event);
...
DictInfoDlg.addSubmit = function () {
    this.collectData();
    //提交信息
    var ajax = new $ax(EASYLIAO.ctxPath + "/dict/add", function (data) {
...
DictInfoDlg.editSubmit = function () {
    this.collectData();
    var ajax = new $ax(EASYLIAO.ctxPath + "/dict/update", function (data) {
