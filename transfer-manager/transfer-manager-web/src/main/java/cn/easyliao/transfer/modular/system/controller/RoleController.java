...
import cn.easyliao.transfer.core.cache.CacheKit;
import cn.easyliao.transfer.core.util.Convert;
import cn.easyliao.transfer.core.util.ToolUtil;
import cn.easyliao.transfer.modular.system.dao.RoleDao;
import cn.easyliao.transfer.modular.system.service.IRoleService;
import cn.easyliao.transfer.modular.system.warpper.RoleWarpper;
...
public class RoleController extends BaseController {
    ...
    public Tip remove(@RequestParam Integer roleId) {
        ...
        //缓存被删除的角色名称
        LogServiceHolder.me().set(ConstantFactory.me().getSingleRoleName(roleId));
