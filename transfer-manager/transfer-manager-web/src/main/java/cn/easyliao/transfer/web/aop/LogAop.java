...
import cn.easyliao.transfer.common.constant.dictmap.factory.DictMapFactory;
...
import cn.easyliao.transfer.core.util.Contrast;
...
public class LogAop {
    ...
    @Pointcut(value = "@annotation(cn.easyliao.transfer.common.annotion.log.BussinessLog)")
    ...
    private void handle(ProceedingJoinPoint point) throws Exception {
        ...
        if (bussinessName.indexOf("修改") != -1 || bussinessName.indexOf("编辑") != -1) {
            Object obj1 = LogServiceHolder.me().get();
        ...
        LogServiceManager.me().executeLog(LogServiceTaskFactory.bussinessLog(user.getId(), bussinessName, className, methodName, msg));
    }
}