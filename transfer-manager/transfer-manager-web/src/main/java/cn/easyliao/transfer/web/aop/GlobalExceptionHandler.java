package cn.easyliao.transfer.web.aop;

import static cn.easyliao.transfer.core.support.HttpKit.getIp;
import static cn.easyliao.transfer.core.support.HttpKit.getRequest;
...
import cn.easyliao.transfer.common.constant.tips.ErrorTip;
...
public class GlobalExceptionHandler {
    ...
    public ErrorTip notFount(BussinessException e) {
        LogServiceManager.me().executeLog(LogServiceTaskFactory.exceptionLog(ShiroKit.getUser().getId(), e));
    ...
    public String accountLocked(DisabledAccountException e, Model model) {
        ...
        LogServiceManager.me().executeLog(LogServiceTaskFactory.loginLog(username, "账号被冻结", getIp()));
    ...
    public String credentials(CredentialsException e, Model model) {
        String username = getRequest().getParameter("username");
        LogServiceManager.me().executeLog(LogServiceTaskFactory.loginLog(username, "账号密码错误", getIp()));
    ...
    public String credentials(InvalidKaptchaException e, Model model) {
        String username = getRequest().getParameter("username");
        LogServiceManager.me().executeLog(LogServiceTaskFactory.loginLog(username, "验证码错误", getIp()));
