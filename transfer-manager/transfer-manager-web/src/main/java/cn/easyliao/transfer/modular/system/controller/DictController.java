...
import cn.easyliao.transfer.modular.system.dao.DictDao;
import cn.easyliao.transfer.modular.system.service.IDictService;
import cn.easyliao.transfer.modular.system.warpper.DictWarpper;
...
public class DictController extends BaseController {
     ...
     */
    @BussinessLog(value = "添加字典记录", key = "dictName,dictValues", dict = cn.easyliao.transfer.common.constant.Dict.DictMap)
     ...
     * 修改字典
     */
    @BussinessLog(value = "修改字典", key = "dictName,dictValues", dict = cn.easyliao.transfer.common.constant.Dict.DictMap)
     ...
     * 删除字典记录
     */
    @BussinessLog(value = "删除字典记录", key = "dictId", dict = cn.easyliao.transfer.common.constant.Dict.DeleteDict)
    ...
    public Object delete(@RequestParam Integer dictId) {
        ...
        //缓存被删除的名称
        LogServiceHolder.me().set(ConstantFactory.me().getDictName(dictId));
