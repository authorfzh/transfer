...
DeptInfoDlg.addSubmit = function() {
    ...
    var simplename=EASYLIAO.checkRequired2(this.deptInfoData.simplename,"部门名称不能为空!");
    
    var pName=EASYLIAO.checkRequired2(this.deptInfoData.pid,"上级部门不能为空!");
    
    if(simplename==false || pName==false ){
    	return;
    }
    //提交信息
    var ajax = new $ax(EASYLIAO.ctxPath + "/dept/add", function(data){
...
DeptInfoDlg.editSubmit = function() {
    ...
    //提交信息
    var ajax = new $ax(EASYLIAO.ctxPath + "/dept/update", function(data){
