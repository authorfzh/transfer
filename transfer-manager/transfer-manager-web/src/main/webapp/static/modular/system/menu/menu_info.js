...
MenuInfoDlg.addSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(EASYLIAO.ctxPath + "/menu/add", function (data) {
...
MenuInfoDlg.editSubmit = function () {
    ...
    //提交信息
    var ajax = new $ax(EASYLIAO.ctxPath + "/menu/edit", function (data) {
...
MenuInfoDlg.showMenuSelectTree = function () {
    EASYLIAO.showInputTree("pcodeName", "pcodeTreeDiv", 15, 34);
};
